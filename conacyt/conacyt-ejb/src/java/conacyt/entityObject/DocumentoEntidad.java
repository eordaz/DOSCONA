...
public class DocumentoEntidad implements Serializable {
    ...
    public int getId_documentos_proy() {
        return id_documentos_proy;
    }

    public void setId_documentos_proy(int id_documentos_proy) {
        this.id_documentos_proy = id_documentos_proy;
    }
