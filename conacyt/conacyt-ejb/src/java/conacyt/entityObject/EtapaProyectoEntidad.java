 ...
 */
@Entity
public class EtapaProyectoEntidad implements Serializable {
   ...
   public Date getFecha_actualizacion() {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EtapaProyectoEntidad)) {
            return false;
        }
        EtapaProyectoEntidad other = (EtapaProyectoEntidad) object;
