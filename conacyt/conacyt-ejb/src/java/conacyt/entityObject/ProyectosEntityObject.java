 ...
 */
@Entity
public class ProyectosEntityObject implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ProyectosEntityObject)) {
            return false;
        }
        ProyectosEntityObject other = (ProyectosEntityObject) object;
    ...
    public static void main(String[] args) {
            ...
            array.add(json);
            //Recorremos el Array
            ProyectosEntityObject p = new ProyectosEntityObject();
